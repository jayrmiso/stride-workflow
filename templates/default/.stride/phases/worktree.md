...
If the active worktree does not contain the local env file, use the repo checkout or parent project folder that does contain it when starting local tests.
